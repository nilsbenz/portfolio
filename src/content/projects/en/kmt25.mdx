...
description: "Website und App for the Rheintaler Kreismusiktage 2025 in Diepoldsau"
thumbnail: "@/assets/projects/kmt25/thumbnail-de.png"
featured: true
---
import Technologies from "@/components/projects/Technologies.astro";

I developed the official website and accompanying progressive web app (PWA) for the Rheintaler Kreismusiktage 2025 in Diepoldsau. The concept and UI design were created by Marco Nussbaumer. The website can be accessed at [kmt25.ch](https://kmt25.ch).
